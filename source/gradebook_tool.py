...
# Form implementation generated from reading ui file 'source\gradebook_tool.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.groupBox_5, 4, 0, 1, 4)
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(9, 9, 601, 221))
        ...
        self.gridLayout_4.addWidget(self.DBConnectionStatusLabel, 1, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.DBConnection, 0, 0, 1, 1)
        self.DBLoadButton = QtWidgets.QPushButton(self.groupBox_2)
        self.DBLoadButton.setMaximumSize(QtCore.QSize(150, 16777215))
        self.DBLoadButton.setObjectName("DBLoadButton")
        self.gridLayout_4.addWidget(self.DBLoadButton, 1, 2, 1, 1)
        self.fallbackConnection = QtWidgets.QGroupBox(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_4.addWidget(self.fallbackConnection, 0, 1, 1, 2)
        self.groupBox_4 = QtWidgets.QGroupBox(self.tab_3)
        self.groupBox_4.setGeometry(QtCore.QRect(0, 250, 621, 151))
        ...
        self.outputProgressBar = QtWidgets.QProgressBar(self.groupBox_4)
        self.outputProgressBar.setProperty("value", 24)
        self.outputProgressBar.setObjectName("outputProgressBar")
        self.gridLayout_3.addWidget(self.outputProgressBar, 1, 0, 1, 1)
        self.outputSaveButton = QtWidgets.QPushButton(self.groupBox_4)
        self.outputSaveButton.setObjectName("outputSaveButton")
        self.gridLayout_3.addWidget(self.outputSaveButton, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.outputSaveButton.setText(_translate("MainWindow", "Save"))
